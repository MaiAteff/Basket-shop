    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="w-[90%] mx-auto px-4 py-12">
        ...
        <p className="text-[#202435] text-[14px] leading-relaxed mb-8">
          ...
          consectetur quis enim. Nullam id rutrum ex. Aliquam a lectus at ipsum
          rhoncus dapibus non id justo. Vivamus iaculis lacinia vestibulum.
          Etiam at volutpat elit, sed blandit dolor.
        </p>
